...
- [ ] Sourcetree (Git graphical interface optimized for Bitbucket) [download location](https://www.sourcetreeapp.com/) (OPTIONAL)
    - Note that you may run into an error message on mac: "Sourcetree can’t be opened because Apple cannot check it for malicious software.". This is because Sourcetree is not a verified program on Mac. However, you could install the program by force using System Preferences, or running terminal commands.
