...
We have examples of various actual reports (slightly anonymized):
 ...
 + [Example 1](`r config$url$replobsoletemd`sample_report.md)
...
The template used by the Lab can be found on Github at  [`r config$url$replmd`REPLICATION.md](`r config$url$templmd`REPLICATION.md). The table of contents looks like this:
