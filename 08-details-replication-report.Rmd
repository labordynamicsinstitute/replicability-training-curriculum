...
The template used by the Lab can be found on Github [here](`r config$url$replmd`REPLICATION.md](`r config$url$templmd`REPLICATION.md). The table of contents looks like this:
