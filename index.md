...
---
 ...
 <div class="w3-bar w3-black">
  <button class="w3-bar-item w3-button" onclick="openCity('CISER')">CISER</button>
  <button class="w3-bar-item w3-button" onclick="openCity('GHCS')">Github Codespaces</button>
</div> 

#### CISER {#CISER .computeloc .invisible}
